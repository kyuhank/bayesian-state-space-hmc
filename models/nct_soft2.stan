// priorSBC / non-centered / soft biomass floor + soft harvest-rate penalty
// Design intent:
...
// Notes:
//   - Non-centered process noise: ut ~ N(0,1), Pt = PtMedian * exp(sigma * ut).
...
transformed parameters {
  ...
  // Initial median relative biomass and non-centered state reconstruction
  PtMedian[1] = 1;
  ...
  for (t in 2 : (ntimes + 1)) {
    ...
    // Non-centered state update and biomass
...
model {
  ...
  // Standard normal innovations (non-centered process model)
  ut ~ std_normal();
